...
class _DialogoNovoItemState extends State<DialogoNovoItem> {
  ...
  inserir_item_firebase()async{
    ...
    DatabaseReference ref = FirebaseDatabase.instance.ref(controller_mobx.estoque_atual).child("estoque").child(item_add.codigo);
    await ref.set(json);
    await controller_mobx.preenche_lista_estoque_atual();
    await salvar_novo_item_planilha(item_add);
    Navigator.of(context).pop();
    Navigator.of(context).pop();
    Navigator.of(context).pop();
    controller_mobx.estoque_novo_visibile = true;
  ...
  salvar_novo_item_planilha(Item item_add) async{
    ...
    await sheet!.values.appendRow([item_add.codigo, item_add.nome, item_add.qtd, item_add.unidade]);
  }
