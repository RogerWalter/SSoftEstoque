...
import 'DialogoSepararItens.dart';
    ...
    return WillPopScope(
            ...
            floatingActionButton: Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Visibility(
                      visible: !controller_mobx.parametro_origem,
                      ...
                      child: Container(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                                ...
                                onTap: () async{
                                  verificar_conexao();
                                  if(controller_mobx.parametro_origem && !controller_mobx.parametro_houve_alteracao){
                                              ...
                                              child: InkWell(
                                                ...
                                                child: ListTile(
                                                    ...
                                                    trailing: IconButton(
                                                      ...
                                                      onPressed: () {
                                                        int indice_busca = -1;
                                                        indice_busca = controller_mobx.lista_seriais_itens_baixa.indexWhere((element) => (element.codigo == controller_mobx.lista_itens_baixa[index].codigo && element.qtd_informada == controller_mobx.lista_itens_baixa[index].qtd));
      ...
      onWillPop: () async{
        if(controller_mobx.parametro_origem){
          //a tela foi aberta pela "Separações". Portanto, ao pressionar o voltar, deveremos limpar a lista de baixas
                            ...
                            child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                      child: TextButton(
                                        onPressed: (){
                                          controller_mobx.remover_item_baixa(indice, indice_lista_seriais);
                                          controller_mobx.alterar_arametro_houve_alteracao(true);
                                          Navigator.of(context).pop();
                                        },
                                        child: Text(
